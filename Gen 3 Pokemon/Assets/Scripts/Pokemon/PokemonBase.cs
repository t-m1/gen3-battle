...
// Super effective and not very effective moves
public class TypeChart{
    ...
    public static float GetEffectiveness(PokemonType attackType, PokemonType defenseType){
        if (attackType == PokemonType.None || defenseType == PokemonType.None || attackType == PokemonType.Normal || defenseType == PokemonType.Normal){
            return 1;
        }
        if (defenseType == PokemonType.Grass) return 2;
